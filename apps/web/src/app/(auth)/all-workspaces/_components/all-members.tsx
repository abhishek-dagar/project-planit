"use client";
import AddMemberModal from '@/app/(main)/app/settings/workspace/members/_components/add-member-modal';
...
import { AtSignIcon, ChevronRightIcon, EllipsisIcon, RectangleEllipsisIcon, SearchIcon, ShieldCheckIcon, Trash2Icon, WholeWordIcon } from 'lucide-react';
import { useRouter } from 'next/navigation';
import React, { useState } from 'react'
import { toast } from 'sonner';

const AllMembers = ({user}: {user: any}) => {
